...
class TestPerModelMapping:
    ...
    def test_model_sonnet_from_env(self, monkeypatch):
        ...
        monkeypatch.setenv("MODEL_SONNET", "deepseek/deepseek-chat")
        s = Settings()
        assert s.model_sonnet == "deepseek/deepseek-chat"
    ...
    def test_resolve_model_sonnet_override(self):
        ...
        s = Settings()
        s.model_sonnet = "deepseek/deepseek-chat"
        assert (
    ...
    def test_resolve_model_haiku_override(self):
        ...
        assert s.resolve_model("claude-3-haiku-20240307") == "open_router/anthropic/claude-3-haiku"
        assert s.resolve_model("claude-3-5-haiku-20241022") == "open_router/anthropic/claude-3-haiku"
        assert s.resolve_model("claude-haiku-4-20250514") == "open_router/anthropic/claude-3-haiku"
    ...
    def test_resolve_model_fallback_when_override_not_set(self):
        ...
        s = Settings()
        s.model = "deepseek/fallback-model"
        # No model overrides set
        assert s.resolve_model("claude-opus-4-20250514") == "deepseek/fallback-model"
        assert (
            s.resolve_model("claude-sonnet-4-20250514") == "deepseek/fallback-model"
        )
        assert s.resolve_model("claude-3-haiku-20240307") == "deepseek/fallback-model"
    ...
    def test_resolve_model_unknown_model_falls_back(self):
        ...
        assert s.resolve_model("claude-2.1") == "deepseek/fallback-model"
        assert s.resolve_model("some-unknown-model") == "deepseek/fallback-model"
    ...
    def test_parse_model_name(self):
        ...
        assert Settings.parse_model_name("open_router/anthropic/claude-opus") == "anthropic/claude-opus"
    ...
    def test_configured_chat_model_refs_collects_unique_models_with_sources(
        ...
        s = Settings()
        s.model = "deepseek/fallback"
        s.model_opus = "open_router/anthropic/claude-opus"
        s.model_sonnet = "deepseek/fallback"
        s.model_haiku = None
        ...
        assert refs[0].provider_id == "deepseek"
