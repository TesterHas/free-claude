...
def _summarize_validation_body(body: Any) -> tuple[str, list[str]]:
    ...
    return (f"type={body_type} messages={message_count}", tool_names)
...
def create_app(*, lifespan_enabled: bool = True) -> FastAPI:
    ...
    async def validation_error_handler(request: Request, exc: RequestValidationError):
        ...
        message_summary, tool_names = _summarize_validation_body(body)
